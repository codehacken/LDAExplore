...
// *******************************
// END of the Overview visualization
// *******************************

var width = document.body.clientWidth,
    height = 10 +d3.max([document.body.clientHeight-540, 240]);
...
d3.csv("data/data.csv", function(raw_data) {
  ...
  $.ajax({
    dataType: "json",
    url: "data/data_names.json",
    async: false,
    success: function(data){colors = data}
  });
